...
---
## 핵심 성과 (Impact First)
* **비용 효율 개선**: 불필요한 고객 접촉 제거로 캠페인 비용 70% 절감
* **성과 개선**: 타겟팅 정밀화로 전환율 47.4% → 70.3% (+48.3%)
* **비즈니스 구조 전환**: 전체 고객이 아닌 상위 확률 고객 기반의 Ranking 전략 적용
* **모델 신뢰성 확보**: Data Leakage 제거로 “실제 운영 가능한 모델” 설계
---

## 문제 정의
> “누구에게 연락해야 비용은 줄이고 전환은 높일 수 있는가?”

기존 방식:
전체 고객 대상 일괄 캠페인 → 낮은 ROI

목표:
고객별 가입 확률을 예측하고
상위 고객만 타겟팅하는 의사결정 시스템 구축
