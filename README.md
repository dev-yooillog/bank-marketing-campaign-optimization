...
- **비즈니스 효과**: 예측 모델을 통한 타겟팅 최적화로 캠페인 접촉 비용 **70% 절감** 및 전환율 **48.3% 향상** 달성
- **모델링 전략**: 데이터 누수(Data Leakage)를 제거한 'Real-world' 모델 설계로 실제 환경과 괴리 최소화
- **핵심 기술**: 행동 기반 변수 엔지니어링 및 머신러닝(XGBoost, Random Forest)을 활용한 고객 순위(Ranking) 모델링
---
